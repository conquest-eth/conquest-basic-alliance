<script lang="ts">
  ...
  const title = 'Basic Alliance, Template for Decentralised Applications.';
...
<footer class="bg-white dark:bg-black">
  <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
    <div class="flex justify-center space-x-6 md:order-2">
      <a href="https://twitter.com/conquest_eth" class="text-gray-400 hover:text-gray-500">
      ...
      <a href="https://github.com/wighawag/conquest-basic-alliance" class="text-gray-400 hover:text-gray-500">
